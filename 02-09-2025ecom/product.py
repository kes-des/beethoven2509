...
print(mobile_vivo)
mobile_vivo = Product(1002, description ='Good good camera.bad services.',name = 'Samsung S24 ultra', category = 'mobile', tags = 'mobile, electronics, smart phone, android phone', stock = 10, price = 130000)
print(mobile_vivo)
